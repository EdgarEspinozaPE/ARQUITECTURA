				...
				<form action="AdminContacts?action=register" class="needs-validation" novalidate method="post">
					<div class="form-row">
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control" id="validationCustomCode" placeholder="nombre" maxlength="45" required name="nombre">
						...
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control" id="validationCustomName" placeholder="telefono" maxlength="45" required name="telefono">
							<div class="invalid-feedback">
						...
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control" id="validationCustomDescription" placeholder="correo" maxlength="45" required name="correo">
							<div class="invalid-feedback">
								Ingrese un correo.
							</div>
						</div>
